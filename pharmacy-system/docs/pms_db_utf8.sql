...
CREATE TABLE `user` (
  ...
  `role` enum('admin','staff','demo') NOT NULL COMMENT '角色：admin=管理员，staff=店员，demo=演示只读账号',
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户/操作员表';
...
(21,'demo','123456','演示访客','demo','13800000021',1,'演示账号，仅支持查看，禁止新增、修改、删除、导入和导出','2026-05-01 09:40:00','2026-05-01 09:40:00');
